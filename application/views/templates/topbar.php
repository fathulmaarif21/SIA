    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                ...
                <li><a href="<?= base_url(); ?>admin/viewMasterTrxPenjualan" class="dropdown-item"><i class="nav-icon fas fa-envelope-open-text"></i> Master Transaksi Penjualan </a></li>
                <li><a href="<?= base_url(); ?>admin/masterFaktuPembelian" class="dropdown-item"><i class="nav-icon fas fa-exchange-alt"></i> Master Faktur Pembelian </a></li>
